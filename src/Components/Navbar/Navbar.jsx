...
const Navbar = () => {
  ...
  return (
    <>
      <div className="p-1 w-full bg-yellow-700">
        <h3 className="text-black font-inter text-2xl font-bold tracking-normal leading-none text-center">
          WELCOME
        </h3>
      </div>
      <div className="flex justify-around items-center pt-10 pb-10">
        <div>
          <img className="w-full" src={logo} alt="emart" />
        </div>
      ...
      <div className=" bg-black p-3 w-full flex justify-around">
