      ...
      {cart && cart.length > 0 ? (
                    ...
                    <div className=" grid grid-cols-2 py-4 ">
                      <div>
                        ...
                        <div className=" flex flex-col items-start">
                          <h4 className=" text-black text-base font-inter font-semibold tracking-normal leading-none pt-2">
                            {item.name}
                          </h4>
                        </div>
                      ...
                      <div>
                        ...
                        <div className=" pt-4">
                          <Tooltip content="Remove from bag" placement="bottom">
                            <Button
        ...
        <Fragment>
          ...
          >
            ...
            <DialogBody divider>
              <div>
                <h1 className=" text-black text-3xl font-inter font-semibold tracking-normal leading-none py-2">
                  Your bag is empty!!!
                </h1>
                <p className=" text-black text-base font-inter tracking-normal leading-none ">
                  Add some items to your shopping bag!
                </p>
              </div>
            </DialogBody>
          </Dialog>
